...
function ChartArea({ stock, stocks, onBacktestUpdate, onSelectStock, backtestData }) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="min-h-[250px] max-h-[350px] md:min-h-[300px] md:max-h-[45vh] bg-dark-800 rounded-xl border border-dark-600 overflow-hidden mb-4" ref={chartContainerRef}>
      ...
      <div className="md:hidden mb-4 bg-dark-800 rounded-xl border border-dark-600 overflow-hidden">
        ...
        <div className={`
          ...
          ${performanceExpanded ? 'max-h-[500px]' : 'max-h-0'}
        `}>
          <BacktestPanel
