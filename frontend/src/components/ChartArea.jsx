...
function ChartArea({ stock, stocks, onBacktestUpdate, onSelectStock }) {
  const chartContainerRef = useRef(null)
  const { formatPrice, formatChange } = useCurrency()
  const [timeframe, setTimeframe] = useState('M') // M = Monthly (default), W = Weekly, D = Daily
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-[400px] bg-dark-800 rounded-xl border border-dark-600 overflow-hidden mb-4" ref={chartContainerRef}>
