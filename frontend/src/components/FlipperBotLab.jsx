                  ...
                  <div key={pos.id} className="p-4 hover:bg-dark-700/50 transition-colors">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="text-right">
                        <div className="text-white font-medium">{formatPrice(pos.current_price)}</div>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      <div>
                        ...
                        <span className="text-gray-300 ml-1">{formatPrice(pos.avg_price)}</span>
                      </div>
                      <div>
                        <span className="text-gray-500">Datum:</span>
                        <span className="text-gray-300 ml-1">{formatDate(pos.buy_date)}</span>
                      </div>
                      <div className="text-right">
                        <span className={`font-medium ${pos.total_return_pct >= 0 ? 'text-green-400' : 'text-red-400'}`}>
