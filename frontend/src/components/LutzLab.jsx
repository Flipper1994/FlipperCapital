      ...
      <div className="flex-1 p-4 md:p-6 flex items-center justify-center">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2 flex items-center justify-center gap-2">
            Lutz Lab
            <span className="px-2 py-0.5 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs font-bold rounded">BETA</span>
          </h1>
          {!isLoggedIn ? (
            <>
              <p className="text-gray-400 mb-6">Melde dich an, um den Lutz Lab zu nutzen und die automatisierte Trading-Strategie zu verfolgen.</p>
            ...
            <>
              <p className="text-gray-400 mb-6">Um den Lutz Lab zu nutzen, musst du mindestens eine Aktie in deinem Portfolio haben.</p>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <div className="inline-flex items-center bg-dark-800 rounded-xl border border-dark-600 p-1">
            ...
            >
              <svg className={`w-4 h-4 ${!isLive ? 'text-orange-400' : 'text-gray-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-orange-400">Strategie: BX Trender Aggressiv-Momentum</h3>
              <p className="text-sm text-gray-400 mt-2">
                Offensive Momentum-Strategie mit fruehzeitiger Positionierung. Entry bereits beim ersten/zweiten hellroten Bar (antizipatives Early-Reversal-Signal) oder beim Rot-zu-Gruen-Uebergang. Exit beim ersten dunkelroten Bar. Hoehere Trade-Frequenz, groesseres Exposure-Fenster und frueherer Einstieg in Aufwaertsbewegungen bei hoeherem Drawdown-Risiko.
              </p>
            </div>
          </div>
        </div>
