...
function Sidebar({ isLoggedIn, isAdmin, user, isOpen, onClose }) {
  const navItems = [
    ...
    { path: '/quant-lab', label: 'Quant Lab', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z', quant: true },
                ...
                <li key={item.path}>
                  {(isLocked || isAuthLocked) ? (
                    ...
                    >
                      ...
                      {item.quant && (
                        <span className="ml-auto px-1.5 py-0.5 bg-gradient-to-r from-violet-500 to-purple-500 text-white text-[10px] font-bold rounded">
                          BETA
                        </span>
                      )}
                    </NavLink>
